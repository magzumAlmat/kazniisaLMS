...
export default function StreamsPage() {
  ...
  // ... (предыдущий код с useState, useEffect и функциями остается без изменений)

// Обновленный return с исправлениями
return (
  <>
    ...
    <Box sx={{ maxWidth: 1200, mx: 'auto', p: 3 }}>
      ...
      <Button
        ...
        sx={{ mb: 3 }}
        disabled={!courses.length || !users.length} // Отключаем кнопку, если данные не загружены
      >
        Создать поток
      </Button>
      ...
      <Dialog open={openCreate} onClose={() => setOpenCreate(false)}>
        ...
        <DialogContent>
          ...
          <FormControl fullWidth sx={{ mt: 2 }}>
            ...
            <Select
              value={newStream.courseId || ''} // Убедимся, что значение всегда определено
          ...
          <FormControl fullWidth sx={{ mt: 2 }}>
            ...
            <Select
              value={newStream.teacherId || ''} // Убедимся, что значение всегда определено
        ...
        <DialogActions>
          ...
          <Button
            ...
            color="primary"
            disabled={!newStream.courseId || !newStream.teacherId} // Требуем выбор курса и учителя
          >
            Создать
          </Button>
        </DialogActions>
      ...
      {/* Остальные диалоги (Edit и Students) остаются без изменений */}
